...
from lib.kfold import split_data
from myclassifier.recurrent import handle_k_fold
...
##    handle_k_fold('2 layer 100 nodes 0.001 l2', models_rnn[0], k_fold, 100, 0.2, 0.001, epochs, trains, tests)
##    handle_k_fold('2 layer 100 nodes 0.005 l2', models_rnn[0], k_fold, 100, 0.2, 0.005, epochs, trains, tests)
##    handle_k_fold('2 layer 100 nodes 0.01 l2', models_rnn[0], k_fold, 100, 0.2, 0.01, epochs, trains, tests)
##    handle_k_fold('2 layer 100 nodes 0.02 l2', models_rnn[0], k_fold, 100, 0.2, 0.02, epochs, trains, tests)


##    handle_k_fold('2 layer 50 nodes 0.01 l2', models_rnn[0], k_fold, 50, 0.2, 0.01, epochs, trains, tests)
##    handle_k_fold('2 layer 200 nodes 0.01 l2', models_rnn[0], k_fold, 200, 0.2, 0.01, epochs, trains, tests)


##    handle_k_fold('1 layer 50 nodes 0.01 l2', models_rnn[1], k_fold, 50, 0.2, 0.01, epochs, trains, tests)
##    handle_k_fold('3 layer 50 nodes 0.01 l2', models_rnn[2], k_fold, 50, 0.2, 0.01, epochs, trains, tests)
